...
function love.load()
  ...
  for i=0,7 do
    enemies_controller:spawnEnemyWave3(i * 20, 0)
  end
end
...
function enemies_controller:spawnEnemyWave3(x, y)
  enemy = {}
  enemy.x = x+2
  enemy.y = y - 40
  enemy.width = 18   
...
function love.update(dt)
 ...
 --[[ if love.keyboard.isDown("q") and game_over == true or love.keyboard.isDown("q") and game_win == true then
  ...
  if love.keyboard.isDown("e") and game_win == true then
    ...
    game_over = false
    package.loaded.myModule = nil
    love.filesystem.load('data/win.lua') ()
    love.load()
  end
end
...
function love.draw()
  ...
  elseif game_win then
    ...
    love.graphics.print("Press 'E' to finish them for good", 35, 70, 0, 0.5)
